...
registerStyles('leaflet-map', $css_0, {moduleId: 'flow_css_mod_0'});
import $cssFromFile_1 from 'Frontend/generated/jar-resources/styles/leaflet-lumo-theme.css?inline';
const $css_1 = typeof $cssFromFile_1  === 'string' ? unsafeCSS($cssFromFile_1) : $cssFromFile_1;
registerStyles('leaflet-map', $css_1, {moduleId: 'flow_css_mod_1'});
import $cssFromFile_2 from 'leaflet.fullscreen/Control.FullScreen.css?inline';
const $css_2 = typeof $cssFromFile_2  === 'string' ? unsafeCSS($cssFromFile_2) : $cssFromFile_2;
registerStyles('leaflet-map', $css_2, {moduleId: 'flow_css_mod_2'});
import $cssFromFile_3 from 'leaflet.markercluster/dist/MarkerCluster.css?inline';
const $css_3 = typeof $cssFromFile_3  === 'string' ? unsafeCSS($cssFromFile_3) : $cssFromFile_3;
registerStyles('leaflet-map', $css_3, {moduleId: 'flow_css_mod_3'});
import $cssFromFile_4 from 'leaflet.markercluster/dist/MarkerCluster.Default.css?inline';
const $css_4 = typeof $cssFromFile_4  === 'string' ? unsafeCSS($cssFromFile_4) : $cssFromFile_4;
registerStyles('leaflet-map', $css_4, {moduleId: 'flow_css_mod_4'});
...
import 'Frontend/generated/jar-resources/leaflet-map.js';
import 'leaflet/dist/leaflet-src.js';
import 'leaflet-canvas-marker/src/_full.js';
import 'esri-leaflet/dist/esri-leaflet.js';
import 'esri-leaflet-vector/dist/esri-leaflet-vector.js';
import 'Frontend/generated/jar-resources/esri-vector-basemap-layer.js';
